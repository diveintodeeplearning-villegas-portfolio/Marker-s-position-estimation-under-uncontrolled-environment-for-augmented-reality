...
{
	public class NormalDeepLearning : CrossValidationPerceptronLearning
	{
		...
		public static Accord.Neuro.Learning.ParallelResilientBackpropagationLearning teacher2;
		...
		public NormalDeepLearning()
		{
		}

		public NormalDeepLearning(double[][] inputs, double[][] outputs, double[][] validationInputs, double[][] validationOutputs, double[][] testInputs, double[][] testOutputs)
		{
			...
			myAccordSigmoidStochasticFunction2 function = new myAccordSigmoidStochasticFunction2(2, network, teacher2);


			//int[] hn  = {10,5,1};
			network = new DeepBeliefNetwork(function, inputs.First().Length, hn);
			//network2 = new DeepBeliefNetwork(function2, inputs.First().Length, 1);
			...
			//Supervised teacher
			teacher2 = new Accord.Neuro.Learning.ParallelResilientBackpropagationLearning(network);
		...
		public void writePredictedErrors(DeepBeliefNetwork network, double[][] inputs, double[][] outputs)
		{
			...
			double[] transOutput = transobj.multiplyVectorByConst(outputs, 0, 1); //1000
			double[] transPredicted = transobj.multiplyVectorByConst(predictedValues, 0, 1); //1000
		...
		public void writePredictedErrors(DeepBeliefNetwork network, double[][] inputs, double[][] outputs)
		{
			...
			double[] transOutput = transobj.multiplyVectorByConst(outputs, 0, 1000); //1000
			double[] transPredicted = transobj.multiplyVectorByConst(predictedValues, 0, 1000); //1000
		...
		*/
		...
		public void trainingValidationDeepBelief(DeepBeliefNetworkLearning teacher, Accord.Neuro.Learning.ParallelResilientBackpropagationLearning  teacher2, DeepBeliefNetwork network, double[][][] batches, int iter1, int iter2, double[][] inputs, double[][] outputs, double[][] validationInputs, double[][] validationOutputs, int flag1, int flag2)
		{
		...
		public void trainingDeepBelief2(DeepBeliefNetworkLearning teacher, Accord.Neuro.Learning.ParallelResilientBackpropagationLearning  teacher2, DeepBeliefNetwork network, double[][][] batches, int iter1, int iter2, double[][] inputs, double[][] outputs, int flag1, int flag2)
		{
			...
			if (flag2 == 1)
			{
				...
				{
					double error2 = teacher2.RunEpoch(inputs, outputs) / inputs.Length;
