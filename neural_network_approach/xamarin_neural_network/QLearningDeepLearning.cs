...
namespace xamarin_neural_network
{
	...
	public class QLearningDeepLearning
	{
		public QLearningDeepLearning()
		{
		...
		// exploration policy
		private Accord.MachineLearning.IExplorationPolicy explorationPolicy;
		...
		/// 
		public Accord.MachineLearning.IExplorationPolicy ExplorationPolicy
		{
		...
		/// is used.</remarks>
		/// 
		public QLearningDeepLearning(int states, int actions, Accord.MachineLearning.IExplorationPolicy explorationPolicy) :
		...
		/// 
		public QLearningDeepLearning(int states, int actions, Accord.MachineLearning.IExplorationPolicy explorationPolicy, bool randomize)
		{
			this.states = states;
